export default class Utilities {
     ...
     */
    static stableSort(list: any, comparator: any): void;
    /**
     ...
     */
    static suppressErrors(method: any, description: any): (...params: any[]) => any;
    /**
     ...
     */
    static formatTString(string: any, values: any): any;
    /**
     ...
     */
    static findInTree(tree: any, searchFilter: any, { walkable, ignore }?: {
        walkable?: null | undefined;
     ...
     */
    static getNestedProp(obj: any, path: any): any;
    /**
     ...
     */
    static addToPrototype(object: any, prop: any, func: any): any;
    /**
     ...
     */
    static deepfreeze(object: any, exclude: any): any;
    /**
     ...
     * @param {number} delay
     */
    static debounce(executor: any, delay: any): (...args: any[]) => void;
    /**
     ...
     */
    static loadData(name: any, key: any, defaultData: any): any;
    /**
     ...
     */
    static saveData(name: any, key: any, data: any): void;
    /**
     ...
     */
    static loadSettings(name: any, defaultSettings: any): any;
    /**
     * Saves settings through BetterDiscord's API.
     * @param {string} name - name for the file (usually plugin name)
     * @param {object} data - settings to save
     */
    static saveSettings(name: any, data: any): void;
}
