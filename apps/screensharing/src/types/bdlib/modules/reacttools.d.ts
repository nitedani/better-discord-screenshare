export default class ReactTools {
     ...
     */
    static getReactInstance(node: any): any;
    /**
     ...
     */
    static getReactProperty(node: any, path: any): any;
    /**
     * Grabs a value from the react internal instance. Allows you to grab
     * long depth values safely without accessing no longer valid properties.
     * @param {(HTMLElement|jQuery)} node - node to obtain react instance of
     ...
     */
    static getOwnerInstance(node: any, { include, exclude, filter }?: {
        include: any;
        exclude?: string[] | undefined;
        filter?: ((_: any) => any) | undefined;
    }): any;
    /**
     ...
     */
    static getStateNodes(node: any): never[];
    /**
     ...
     */
    static getComponents(node: any): never[];
    /**
     ...
     */
    static createWrappedElement(element: any): any;
    /**
     ...
     */
    static wrapElement(element: any): {
        new (props: any): {
            [x: string]: any;
