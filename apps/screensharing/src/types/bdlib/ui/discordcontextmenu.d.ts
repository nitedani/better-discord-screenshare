...
export default class DiscordContextMenu {
     ...
     */
    static buildMenu(setup: any): (props: any) => any;
    /**
     *
     ...
     */
    static openContextMenu(event: any, menuComponent: any, config: any): any;
    /**
     ...
     */
    static getDiscordMenu(nameOrFilter: any): Promise<unknown>;
    /**
