...
export default Utilities.memoizeObject({
  ...
  get LocaleManager() {
    return WebpackModules.getModule(
      (m) => m.Messages && Object.keys(m.Messages).length
    );
  },
  get Moment() {
  ...
  get PrivacySettingsModal() {
    return WebpackModules.getModule(
      (m) => m.open && m.open.toString().includes("PRIVACY_SETTINGS_MODAL")
    );
  },
  get Changelog() {
    return WebpackModules.getModule(
  ...
  get UserPopout() {
    return WebpackModules.getModule(
      (m) => m.type.displayName === "UserPopoutContainer"
    );
  },
  ...
  get TextElement() {
    return (
      WebpackModules.getByDisplayName("LegacyText") ||
  ...
  get AdvancedScrollerThin() {
    return WebpackModules.getByProps("AdvancedScrollerThin")
      .AdvancedScrollerThin;
  },
  get AdvancedScrollerAuto() {
    return WebpackModules.getByProps("AdvancedScrollerAuto")
      .AdvancedScrollerAuto;
  },
  get AdvancedScrollerNone() {
    return WebpackModules.getByProps("AdvancedScrollerNone")
