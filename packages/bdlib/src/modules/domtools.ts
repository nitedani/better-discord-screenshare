...
export default class DOMTools {
  ...
  static parents(element, selector = "") {
    const parents = [];
    if (selector)
      while (element.parentElement && element.parentElement.closest(selector))
        parents.push((element = element.parentElement.closest(selector)));
    else
  ...
  static parentsUntil(element, selector) {
    const parents = [];
    while (element.parentElement && !element.parentElement.matches(selector))
      parents.push((element = element.parentElement));
    return parents;
  }
