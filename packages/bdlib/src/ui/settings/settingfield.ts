...
const LayerProvider = WebpackModules.getByProps(
  "AppReferencePositionLayer"
).AppLayerProvider().props.layerContext.Provider; // eslint-disable-line new-cap
  ...
  get dividerElement() {
    return DiscordModules.React.createElement("div", {
      className: DiscordClasses.Dividers.divider
        .add(DiscordClasses.Dividers.dividerDefault)
        .toString(),
    });
  }
  ...
  render() {
    ...
    if (this.props.inline) {
      ...
      const titleDefault = WebpackModules.getByProps("titleDefault")
        ...
        : "titleDefault-a8-ZSr title-31JmR4 da-titleDefault da-title";
      return ce(
        Flex,
