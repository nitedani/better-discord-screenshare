...
const { default: Tooltip, TooltipPositions } =
        ...
        React.createElement(
          ...
          (tooltipProps) =>
            React.createElement(
              ...
              React.createElement(
                ColorPickerComponents.DefaultColorButton,
                Object.assign(props, { color: this.props.defaultColor })
              )
            )
        ),
      renderCustomButton: () =>
              ...
              (tooltipProps) =>
                React.createElement(
                  ...
                  React.createElement(Swatch, {
                    ...
                    isSelected:
                      !this.props.colors.includes(this.state.value) &&
                      this.props.defaultColor !== this.state.value,
